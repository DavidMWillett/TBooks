...
# Find LibreOffice.
_lopaths=(
        ('/usr/lib64/libreoffice/program',   '/usr/lib64/libreoffice/basis3.4/program'),
        ('/opt/libreoffice/program', '/opt/libreoffice/basis3.4/program'),
     )
